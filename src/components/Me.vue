<template>
  <div class="me" @scroll="showhead">
      <div class="me-show" v-show="scoshow">
          ...
          <div class="me-show-title" v-if="denglu">{{tel}}</div>
          <div class="me-show-title" @click="goregister" v-else>登录/注册</div>
    ...
    <div class="me-head-box">
      <div class="me-head-box1">
        ...
        <div class="me-head-title" v-if="denglu">{{tel}}</div>
        <div class="me-head-title" @click="goregister" v-else>登录/注册</div>
...
export default {
  ...
  created(){
    ...
    this.myphoto = this.$store.state.myphoto

    //获取积分，优惠券，代金券
    this.axios.get('/api/getMys').then((res)=>{

        console.log(res.data);

        if(res.data.status == 200){

            this.$store.state.jifen = res.data.jifen
            this.$store.state.youhui = res.data.youhui
            this.$store.state.daijin = res.data.daijin
